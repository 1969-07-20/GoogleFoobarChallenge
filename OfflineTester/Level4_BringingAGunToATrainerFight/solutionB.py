...
source_url = "https://github.com/franklinvp/foobar/blob/master/foobar2018/challenge6_number_of_reflections.py"
...
def number_of_reflections(dimensions, your_position, guard_position, distance):
    ...
    def clear_of_suicide_or_double_kill(target_rel_to_me):
        ...
        for scale in range(1, common_factor):
    ...
    for i in range(-horizontal_reflections, horizontal_reflections+1):
        ...
        for j in range(-vertical_reflections, vertical_reflections+1):
