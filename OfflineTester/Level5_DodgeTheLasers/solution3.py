...
source_url = "https://github.com/arinkverma/google-foobar/blob/master/5.1_dodge_the_lasers.py"


#  Mod:
#  - Replace call to 'long()' with 'int()'
...
def s(n):
    ...
    if n < 1:
        return 0
    return int(n * n1(n) + n * (n + 1) / 2 - n1(n) * (n1(n) + 1) / 2 - s(n1(n)))
